        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="col-lg-6">
                    ...
                    <form  enctype="multipart/form-data"  name="add_pages_form" id="add_pages_form" action="{{url('admin/add-post-details')}}" enctype="multipart-form/data" method="post">
                        <!-- /.col-lg-6 (nested) -->
                        ...
                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="post_content"  id="editor" rows="10" cols="80"></textarea>
                        ...
                        <div class="form-group">
                            <label>Title3</label>
                             <textarea name="post_title3" id="editor1" rows="10" cols="80"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Tag Line</label>
                            <textarea name="post_tagline" id="editor2" rows="10" cols="80"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Short Description</label>
                            <textarea name="post_short_desc" id="editor3" rows="10" cols="80"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Long Description</label>
                            <textarea name="post_long_description" id="editor4" rows="10" cols="80"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
...
<?php } ?>
    ...
    $("body #add_pages_form").validate({
        ...
        messages: {
            ...
            parent_service: {
                required: "Please select parent service"
            }
        },
