            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table  width="100%" class="table table-striped table-bordered table-hover" id="myTable">
                        ...
                        <tbody>
                            @if(count($dataArray["managePagesData"])>0)
                            @foreach($dataArray["managePagesData"] as $key=>$val)
                            <tr class="gradeX">
                                <td>{{$val->title}}</td>
                                <td>{{$val->post_type}}</td>
                                ...
                                <td><a href="{{ url('/admin/edit-page-posts/'.$val->post_slug)}}"  class="editPage">Edit</a></td>
