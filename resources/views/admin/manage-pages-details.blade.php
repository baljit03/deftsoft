        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="col-lg-6">
                    ...
                    <form  enctype="multipart/form-data"  name="manage_pages_form" id="manage_pages_form" action="{{url('admin/mange-pages-details')}}" enctype="multipart-form/data" method="post">
                        <!-- /.col-lg-6 (nested) -->
                        ...
                        <div class="form-group">
                            <label>Title3</label>
                            <textarea name="post_title3" id="editor1" rows="10" cols="80">{{$dataArray["postDetails"][0]->title3}}</textarea>
                        </div>
                        <div class="form-group">
...
//    CKEDITOR.replace('post_short_desc');
//    CKEDITOR.replace('post_long_description');
//    CKEDITOR.replace('post_title3');
//    CKEDITOR.replace('post_tagline');
