        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="col-lg-6">
                    ...
                    <form  enctype="multipart/form-data"  name="edit_menu_form" id="edit_menu_form" action="{{url('admin/edit-header-menu-detail')}}" enctype="multipart-form/data" method="post">
                        <!-- /.col-lg-6 (nested) -->
                        <div class="form-group">
                            <label>Menu Name</label>
                            <input class="form-control" name="menu_name" value="{{$dataArray["headerMenuData"]->name}}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="post_category" id="post_category" class="form-control" >
                                ...
                                foreach ($dataArray["pagePost"] as $key => $val) {
                                    ?>
                                    <option value="{{$val->id}}"  <?php echo $dataArray["headerMenuData"]->post_id == $val->id ? 'selected="selected"' : ''; ?>  >{{$val->title}}</option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="menu_index" value="{{$dataArray["headerMenuData"]->header_sort_index}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="menu_status">
                                <option value="Active"  <?php echo $dataArray["headerMenuData"]->status == 'Active' ? 'selected="selected"' : ''; ?> >Active</option>
                                <option value="Inactive" <?php echo $dataArray["headerMenuData"]->status == 'Inactive' ? 'selected="selected"' : ''; ?> >Inactive</option>
                            </select>
                        </div>
                        <input type="hidden" name="menuId" value="{{$dataArray["headerMenuData"]->id}}" />
