...
<html lang="en">
    ...
    <body>
        ...
        <!-- jQuery -->
        <script src="{{url('admin_assest/vendor/jquery/jquery.min.js')}}"></script>

        <!-- Bootstrap Core JavaScript -->
        <script src="{{url('admin_assest/vendor/bootstrap/js/bootstrap.min.js')}}"></script>

        <!-- Metis Menu Plugin JavaScript -->
        <script src="{{url('admin_assest/vendor/metisMenu/metisMenu.min.js')}}"></script>

        <!-- Custom Theme JavaScript -->
        <script src="{{url('admin_assest/dist/js/sb-admin-2.js')}}"></script>
