...
<style>
                        ...
                        <div class="ds-blog-main"> 
                            <div class="row">
                                <div class="col-md-8 col-sm-8 col-xs-12 ds-blog-content"> 
                                    <article class="post">
                                        <?php
                                        if (!empty($dataArray["ParentPostMeta"]->blogData[0]->blogImg)) {
                                            $img = $dataArray["ParentPostMeta"]->blogData[0]->blogImg;
                                        } else {
                                            $img = 'default.png';
                                        }
                                        ?>
                                        ...
                                        <div class="enrty-meta-bar">
                                            <div class="entry-meta">
                                                <span class="by-author"><a href="javascript:;"><i class="fa fa-user"></i> {{$dataArray["ParentPostMeta"]->blogData[0]->firstname}}{{$dataArray["ParentPostMeta"]->blogData[0]->lastname}}</a></span>
                                                <span class="date"><a href="javascript:;"><i class="fa fa-clock-o"></i>{{date("d F Y",strtotime($dataArray["ParentPostMeta"]->blogData[0]->created_at))}}</a></span>
                                        ...
                                        <div class="entry-content">
                                            <h2 class="post-title">{!!$dataArray["ParentPostMeta"]->blogData[0]->title!!}</h2>             
                                            <p>{!!$dataArray["ParentPostMeta"]->blogData[0]->description!!}</p>
                                        </div>
                                    </article>
                                    <!-- post article End -->      
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 ds-blog-sidebar"> 
                                    ...
                                    <div class="category-box">
                                        ...
                                        <ul>
                                            ...
                                            foreach ($dataArray["ParentPostMeta"]->blogCategory as $key => $val) {
                                                ?>
    ...
    <script>
        ...
        $("body").on("click", "#keyword_search", function () {
            ...
            $.ajax({
                url: "{{url('blog-keyword-search-session')}}",
                type: "POST",
                data: dataString,
